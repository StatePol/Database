...
# ppg
ppg_file_path <- file.path(data_dir, paste0("faction_", version_number, ".csv"))
ppg <- read.csv(ppg_file_path)

# ppg leadership
ppg_leadership_file_path <- file.path(data_dir, paste0("board_", version_number, ".csv"))
ppg_leadership <- read.csv(ppg_leadership_file_path)

# presidency
presidency_file_path <- file.path(data_dir, paste0("presidium_", version_number, ".csv"))
